...
export default function HomeSection() {
  ...
  return (
    <section
      className="relative h-screen bg-cover bg-top pt-5 text-white text-center flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-10"
    ...
    >
      ...
      <h1
        ...
        data-aos="fade-up"
      > 
        "Let Your <span className='gnr-gold-text'>Smile Shine</span> with <span className='gnr-gold-text'>Confidence</span>"
      </h1>
